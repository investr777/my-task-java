...
5. Вывод полного списка записей бега пользователя.
6. Построение понедельных отчетов на основании записей о беге пользователя, которые содержат в себе: среднюю скорость, среднее время, общую дистанцию, годовой номер недели и диапозон дат этой недели.
--------------------------------------------------------------------------------------------------------
...
СБОРКА ПРОЕКТА
====================================================
Сборку проекта осуществить командой: gradle build
--------------------------------------------------------------------------------------------------------
...
Постороение понедельных отчеток, GET запрос по URL: localhost:8080/report/by_weeks
--------------------------------------------------------------------------------------------------------
